...
class StreamHandlingInterface(Resource):
    """
    Class handles all operations related to the processing of individual frames
    """

    def __init__(self):
        """
        Constructor for the class, initalises the model and encryption keys
        """
    ...
    def post(self):
        ...
        :return: Findings from model Object Detection as a data dictionary
        """
